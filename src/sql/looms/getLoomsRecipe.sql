...
LEFT JOIN warp_quantity wq_warp
    ON yt.yarn_name = 'warp' AND fr.quantity_id = wq_warp.warp_id

-- Количество для утка
LEFT JOIN weft_quantity wq_weft
    ON yt.yarn_name = 'weft' AND fr.quantity_id = wq_weft.weft_id
